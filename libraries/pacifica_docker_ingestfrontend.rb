...
module PacificaDockerCookbook
  ...
  module Resource
    ...
    # Class to deploy and manage a Pacifica Ingest Frontend Service Container
    class IngestFrontend < PacificaDockerCookbook::Resource::Base
