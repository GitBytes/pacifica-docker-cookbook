...
module PacificaDockerCookbook
  ...
  module Resource
    ...
    # Class to deploy and manage a Pacifica UniqueID Service Container
    class UniqueID < PacificaDockerCookbook::Resource::Base
