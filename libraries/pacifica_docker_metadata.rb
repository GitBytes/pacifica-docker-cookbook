...
module PacificaDockerCookbook
  ...
  module Resource
    ...
    # Class to deploy and manage a Pacifica Metadata Service Container
    class Metadata < PacificaDockerCookbook::Resource::Base
