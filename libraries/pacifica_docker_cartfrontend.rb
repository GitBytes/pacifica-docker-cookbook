...
module PacificaDockerCookbook
  ...
  module Resource
    ...
    # Class to deploy and manage a Pacifica Cartd Frontend Service Container
    class CartFrontend < PacificaDockerCookbook::Resource::Base
