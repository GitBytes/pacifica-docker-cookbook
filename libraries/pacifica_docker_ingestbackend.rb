...
module PacificaDockerCookbook
  ...
  module Resource
    ...
    # Class to deploy and manage a Pacifica Ingest Backend Service Container
    class IngestBackend < PacificaDockerCookbook::Resource::Base
