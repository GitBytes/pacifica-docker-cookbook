...
module PacificaDockerCookbook
  ...
  module Resource
    ...
    # Class to deploy and manage a Pacifica Reporting Service Container
    class Reporting < PacificaDockerCookbook::Resource::Base
