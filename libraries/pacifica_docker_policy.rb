...
module PacificaDockerCookbook
  ...
  module Resource
    ...
    # Class to deploy and manage a Pacifica Policy Service Container
    class Policy < PacificaDockerCookbook::Resource::Base
