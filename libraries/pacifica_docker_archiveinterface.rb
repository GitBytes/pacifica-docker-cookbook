...
module PacificaDockerCookbook
  ...
  module Resource
    ...
    # Class to deploy and manage a Pacifica Archive Interface Service Container
    class ArchiveInterface < PacificaDockerCookbook::Resource::Base
