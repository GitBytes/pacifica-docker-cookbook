...
module PacificaDockerCookbook
  ...
  module Resource
    ...
    # Class to deploy and manage a Pacifica Proxy Service Container
    class Proxy < PacificaDockerCookbook::Resource::Base
